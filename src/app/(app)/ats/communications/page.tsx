    ...
    <div className="grid gap-5 xl:grid-cols-[minmax(320px,0.9fr)_minmax(0,1.4fr)]">
      <Card level={1}>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-xs text-text-secondary">{uiText("Variables:")}{"{{candidateName}}"}, {"{{vacancyTitle}}"}, {"{{companyName}}"}, {"{{stageName}}"}, {"{{reason}}"}, {"{{interviewDate}}"}, {"{{interviewLocation}}"}.</p>
