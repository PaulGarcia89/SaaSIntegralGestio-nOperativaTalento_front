  ...
  return <div className="space-y-7">
    ...
    <section className="grid gap-5 xl:grid-cols-[minmax(0,1.6fr)_minmax(300px,.7fr)]">
      <Card level={1}><CardHeader><CardTitle>{t("scorecards.newVersion")}</CardTitle></CardHeader><CardContent className="space-y-5">
        ...
        <label className="space-y-2 text-sm font-medium">{t("scorecards.instructions")}<textarea className="w-full rounded-xl border border-border-default bg-background p-3" rows={3} value={instructions} onChange={(event) => setInstructions(event.target.value)} /></label>
