...
function DuplicateQueue({ query, onMerge }: { query: ReturnType<typeof useQuery<{ data: DuplicateCandidateMatchDto[]; scannedCandidates: number; truncated: boolean }>>; onMerge: (match: DuplicateCandidateMatchDto) => void }) {
