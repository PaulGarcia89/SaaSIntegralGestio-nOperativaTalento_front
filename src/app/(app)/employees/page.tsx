...
import { Download, Upload, UserPlus, UsersRound } from "lucide-react";
...
function parseEmployeeCsv(source: string, branches: Awaited<ReturnType<typeof fetchBranches>>): ImportRow[] {
...
function downloadEmployeeTemplate() { const csv = "nombre,correo,sucursal,cargo,estado\nAna Perez,ana.perez@empresa.com,Sede principal,Supervisor de tienda,ACTIVO\n"; const url = URL.createObjectURL(new Blob([csv], { type: "text/csv;charset=utf-8" })); const anchor = document.createElement("a"); anchor.href = url; anchor.download = "plantilla-empleados.csv"; anchor.click(); URL.revokeObjectURL(url); }
