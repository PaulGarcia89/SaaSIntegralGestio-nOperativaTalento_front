...
export default function OnboardingOperationsPage() {
  ...
  return <div className="space-y-7">
    ...
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><BellRing className="size-5 text-primary" />Procesamiento de vencimientos</CardTitle></CardHeader>
    ...
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><UsersRound className="size-5 text-primary" />Cohortes de ingreso</CardTitle></CardHeader>
