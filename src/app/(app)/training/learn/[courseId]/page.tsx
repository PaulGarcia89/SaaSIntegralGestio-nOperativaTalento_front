...
import { fetchLearnerTrainingCourse, getApiErrorMessage, heartbeatTrainingVideo, recordTrainingVideoEvent, startTrainingVideo } from "@/lib/backend";
...
export default function TrainingCourseLearnPage() {
  ...
  const progress = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["my-training-assignments"] }),
