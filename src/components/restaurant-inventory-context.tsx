...
export function RestaurantInventoryContextProvider({ children }: { children: ReactNode }) {
  ...
  const selected = warehouses.find((item) => item.id === selectedWarehouseId) ?? warehouses[0];
