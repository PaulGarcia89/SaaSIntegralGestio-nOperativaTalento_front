  ...
  return (
    <section aria-labelledby="integration-guide-title" className="rounded-2xl border border-border-default bg-surface-section p-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        ...
        <GuideItem icon={<Webhook className="size-4" />} title="Webhooks" description={uiText("Notificaciones automáticas para informar a otros sistemas sobre eventos.")} />
      </div>
    </section>
  );
}
