...
import { BookOpen, CalendarDays, Plus, Radio, Webhook } from "lucide-react";
...
import { createTrainingScormLaunchUrl, createTrainingVirtualSession, createTrainingWebhook, decideTrainingRecommendation, fetchTrainingCourses, fetchTrainingIntegrations, getApiErrorMessage, retryTrainingWebhookDelivery, testTrainingWebhooks, uploadTrainingScormPackage } from "@/lib/backend";
