  ...
  return (
    <div className={cn("space-y-3", className)}>
      <button
        ...
        className="flex w-full flex-col items-center gap-3 rounded-md border-2 border-dashed border-border/70 bg-secondary/30 px-6 py-8 text-center transition hover:border-primary/40 hover:bg-secondary/50"
      >
