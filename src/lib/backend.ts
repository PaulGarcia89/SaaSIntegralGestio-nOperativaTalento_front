...
export function fetchRestaurantPurchaseOrders(filters: Record<string, string | number | undefined> = {}) { const query = new URLSearchParams(); Object.entries(filters).forEach(([key, value]) => { if (value !== undefined && value !== "") query.set(key, String(value)); }); return request<RestaurantPurchaseOrderDto[]>(`/restaurant-inventory/purchase-orders${query.size ? `?${query}` : ""}`); }
...
export function fetchRestaurantPriceHistory(filters: Record<string, string | number | undefined> = {}) { const query = new URLSearchParams(); Object.entries(filters).forEach(([key, value]) => { if (value !== undefined && value !== "") query.set(key, String(value)); }); return request<RestaurantPriceHistoryDto[]>(`/restaurant-inventory/price-history${query.size ? `?${query}` : ""}`); }
export function fetchRestaurantPurchaseSuggestions(filters: Record<string, string | number | undefined> = {}) { const query = new URLSearchParams(); Object.entries(filters).forEach(([key, value]) => { if (value !== undefined && value !== "") query.set(key, String(value)); }); return request<RestaurantPurchaseSuggestionDto[]>(`/restaurant-inventory/purchase-suggestions${query.size ? `?${query}` : ""}`); }
...
export function fetchRestaurantInvoices(filters: Record<string, string | number | undefined> = {}) { const query = new URLSearchParams(); Object.entries(filters).forEach(([key, value]) => { if (value !== undefined && value !== "") query.set(key, String(value)); }); return request<RestaurantInvoiceDto[]>(`/restaurant-inventory/invoices${query.size ? `?${query}` : ""}`); }
