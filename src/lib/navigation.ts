...
const configuredNavigation: Array<Omit<NavItem, "featureFlag" | "available" | "requiredPermissions">> = [
  ...
  { href: "/inventory/restaurant/shrinkage", label: "Shrinkage", group: "Analítica", module: "restaurant_inventory", permission: "restaurant_inventory.shrinkage.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports", roles: ["admin_saas", "admin_empresa", "supervisor", "encargado_inventario"] },
