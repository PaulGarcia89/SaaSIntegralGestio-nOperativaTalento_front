...
const configuredNavigation: Array<Omit<NavItem, "featureFlag" | "available" | "requiredPermissions" | "section">> = [
  ...
  { href: "/people/reports", label: "Reportes", group: "Personas", module: "people", permission: "employees.read", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports", roles: ["admin_saas", "admin_empresa", "supervisor"] },
  ...
  { href: "/onboarding/analytics", label: "Reportes", group: "Personas", module: "onboarding", permission: "onboarding.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports" },
  ...
  { href: "/ats/analytics", label: "Reportes", group: "Reclutamiento", module: "ats", permission: "applications.view", audience: "shared", subscriptionStates: live, icon: "reports", roles: ["admin_saas", "admin_empresa", "rrhh", "reclutador"] },
  ...
  { href: "/training", label: "Mis cursos", group: "Aprendizaje", module: "training", permission: "training.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "training" },
  ...
  { href: "/training/results", label: "Reportes", group: "Aprendizaje", module: "training", permission: "training.view", audience: "shared", subscriptionStates: live, icon: "reports", roles: ["admin_saas", "admin_empresa", "instructor"] },
  ...
  { href: "/training/content", label: "Crear y editar cursos", group: "Aprendizaje", module: "training", permission: "training.manage", audience: "shared", subscriptionStates: live, icon: "training", roles: ["admin_saas", "admin_empresa", "rrhh", "instructor"] },
  ...
  { href: "/productivity/reports", label: "Reportes", group: "Productividad", module: "productivity", permission: "productivity.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports", roles: ["admin_saas", "admin_empresa", "supervisor"] },
  ...
  { href: "/inventory/assets/analytics", label: "Reportes", group: "Analítica", module: "asset_inventory", permission: "asset_inventory.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports", roles: ["admin_saas", "admin_empresa", "supervisor", "encargado_inventario"] },
  ...
  { href: "/reports", label: "Reportes", group: "Inicio", module: "dashboard", permission: "dashboard.view", audience: "shared", showInNavigation: false, icon: "reports" },
  ...
  { href: "/admin/reports", label: "Reportes", group: "Administración", module: "admin", permission: "admin.view", audience: "tenant", icon: "reports" },
