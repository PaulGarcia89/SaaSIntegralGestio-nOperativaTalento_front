...
const configuredNavigation: Array<Omit<NavItem, "featureFlag" | "available" | "requiredPermissions">> = [
  ...
  { href: "/inventory", label: "Inventario", group: "Operaciones", module: "asset_inventory", permission: "asset_inventory.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "inventory", roles: ["admin_saas", "admin_empresa", "supervisor", "encargado_inventario", "empleado"] },
  { href: "/inventory/assets", label: "Inventario de activos", group: "Operaciones", module: "asset_inventory", permission: "asset_inventory.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "inventory", roles: ["admin_saas", "admin_empresa", "supervisor", "encargado_inventario", "empleado"] },
  ...
  { href: "/inventory/restaurant", label: "Inventario de restaurante", group: "Operaciones", module: "restaurant_inventory", permission: "restaurant_inventory.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "inventory", roles: ["admin_saas", "admin_empresa", "supervisor", "encargado_inventario"] },
  ...
  { href: "/inventory/restaurant/consumption", label: "Consumo", group: "Operaciones", module: "restaurant_inventory", permission: "restaurant_inventory.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports", roles: ["admin_saas", "admin_empresa", "encargado_inventario"] },
  ...
  { href: "/inventory/restaurant/reports", label: "Reportes", group: "Analítica", module: "restaurant_inventory", permission: "restaurant_inventory.view", audience: "shared", subscriptionStates: live, branchRequired: true, icon: "reports", roles: ["admin_saas", "admin_empresa", "encargado_inventario"] },
